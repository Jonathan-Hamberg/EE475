...
/**
 * This is a timer class. It calls a timer listener at a specified number of milliseconds
 * in the future.
 * 
...
class TimerListener {
   ...
   * This function will return the time to the next call or zero to stop all calls.
   * 
